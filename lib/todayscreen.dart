  ...
  Future<void> _authenticateWithBiometrics() async {
    ...
    try {
      ...
      authenticated = await auth.authenticate(
        localizedReason:
        'Please authenticate to avoid unauthorized access.',
                  ...
                  builder: (context) {
                    ...
                    return SlideAction(
                      ...
                      onSubmit: () async {
                        ...
                        location = "check";
                        if(User.flag == true){
                          EasyPolyGeofencing.startGeofenceService(eventPeriodInSeconds: 2);
                          geofenceStatusStream ??= EasyPolyGeofencing.getGeofenceStream()!
